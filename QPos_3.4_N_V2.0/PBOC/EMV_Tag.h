...
/***************  HKRT Private Tags  **************/
#define  HKRT_TAG_FF01_AID_LIST						0xFF01
	//Tag AID List  Template
#define	 HKRT_TAG_FF02_CA_PUBLIC_KEY				0xFF02
	//Tag CA Public Key Template 
#define	 HKRT_TAG_FF03_TERMINAL_RISK_MANAGEMENT		0xFF03
	//Tag Terminal Risk Management Template 
#define	 HKRT_TAG_FF04_TERMINAL_ACTION_CODE			0xFF04
	//Tag Terminal Action Code 
#define	 HKRT_TAG_DF01_CA_PUBLIC_KEY_MODULUS		0xDF01
	//Tag CA Public Key Modulus
#define	 HKRT_TAG_DF02_CA_PUBLIC_KEY_EXPONENT		0xDF02
	//Tag CA Public Key Exponent
