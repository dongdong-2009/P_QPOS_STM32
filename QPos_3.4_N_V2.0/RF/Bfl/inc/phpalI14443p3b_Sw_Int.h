...
/** FTW min in microseconds */
	...
	/* TB404_X JLL 11/10/11 EmvCo Pcd  FWT + dFWT = (4096 + 384) /fc ~332 - Req. 4.27 */
	#define PHPAL_I14443P3B_SW_FWT_MIN_US           332
#else
...
#ifdef NXPBUILD__PH_EMV
	/* TB000 JLL EMVCo 22/09/01 */
	#define PHPAL_I14443P3B_SW_EXT_TIME_US              200
#else
