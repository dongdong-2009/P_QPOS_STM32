...
#define debug_puts(s)
#define debug_puts_hex(hexnum)
#define debug_puts_hex16(hexnum)
...
#define debug_puts_hex(hexnum)			_debug_puts_hex(hexnum)
#define debug_puts_hex16(hexnum)		_debug_puts_hex16(hexnum)
#define debug_printf_hex(p_hexnum, num)	_debug_printf_hex(p_hexnum, num)
