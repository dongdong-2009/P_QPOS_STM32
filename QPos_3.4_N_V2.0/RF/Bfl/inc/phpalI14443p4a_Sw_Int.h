...
#define PHPAL_I14443P4A_SW_PCB_DESELECT         0x00U
	...
	/** Activation FTW in microseconds - Req. 4.24 */
	#define PHPAL_I14443P4A_SW_FWT_ACTIVATION_US    5286
#else
	/** Activation FTW in microseconds. */
	#define PHPAL_I14443P4A_SW_FWT_ACTIVATION_US    5286   //4833
#endif
...
#ifdef NXPBUILD__PH_EMV
	/* TA201_X JLL 04/10/11 Emv Pcd  - FWT + dFWT = (4096 + 384) /fc ~ 332 */
	#define PHPAL_I14443P4A_SW_FWT_MIN_US           332
#else
