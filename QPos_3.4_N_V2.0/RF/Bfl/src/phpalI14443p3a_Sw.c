                                   ...
                                   )
{
    ...
    /* TA001 JLL 16/09/11: HaltA should be sent with CRC */
...
#ifdef NXPBUILD__PH_EMV
    /* TA001 JLL EMVCo Pcd 24/10/2011 - Requirements 4.27 FDTpcd = 500 µs */
    ...
    )
{
    ...
    /* TA101_X JLL 20/09/2011 EMVCo Pcd */
    /* Parameter check */
    if ((bLenUidIn != 0) &&
        (bLenUidIn != 4) &&
        (bLenUidIn != 7) &&
    ...
    *pMoreCardsAvailable = PH_OFF;
...
#ifdef NXPBUILD__PH_EMV
    /* TA311_X JLL EMVCo Pcd 19/10/2011 - Req 9.6.1.3 */
    ...
    for (bCascadeIndex = 0; bCascadeIndex < 3; bCascadeIndex++)
    {
        ...
        while (bNvbUid != 0x40)
        {
...
#ifdef NXPBUILD__PH_EMV
            /* TA310 JLL EMVCo Pcd 19/10/2011 - Req. 9.6.1.3 */
            ...
            if  ((status & PH_ERR_MASK) == PH_ERR_NOISE_ERROR)
            {
                /* TA302_XX 27/09/2011 EMVCo Pcd - Req. 5.6 */
                return PH_ADD_COMPCODE(PH_ERR_PROTOCOL_ERROR, PH_COMP_PAL_ISO14443P3A);
#else
             if ((status & PH_ERR_MASK) == PH_ERR_COLLISION_ERROR)
             {
...
#ifdef NXPBUILD__PH_EMV
            /* TA302_10 JLL 27/09/2011 EMVCo Pcd Req 9.4 */
            if (((bAtqa[0] & 0xC0) == 0) && (bUid[0] == PHPAL_I14443P3A_CASCADE_TAG))
            {
            	return PH_ADD_COMPCODE(PH_ERR_PROTOCOL_ERROR, PH_COMP_PAL_ISO14443P3A);
            }
#endif
...
#ifdef NXPBUILD__PH_EMV
        /* TA312 JLL EMVCo Pcd 19/10/2011 - Req. 9.6.1.3 */
        ...
        {
        	/* TA305 JLL EMVCo Pcd 30/11/2011 - Req. 9.6.1.2 */
...
#ifndef NXPBUILD__PH_EMV
    /* TA_OPTI_1 JLL 27/09/2011 - EMVCo PCD - Optimize the timing processing */
...
#ifndef NXPBUILD__PH_EMV
    /* TA_OPTI_2 JLL 27/09/2011 - EMVCo PCD */
    /* Set RxDeafTime to 8 Bits - redundant code */
...
#ifdef NXPBUILD__PH_EMV
    /* TA304_10, TA304_11, TA304_12 JLL 27/09/2011 EMVCo Pcd - Req. 5.3.2 */
    if ((pResp[0] == 0xC1) || (pResp[0] == 0x11) || (pResp[0] == 0x00))
    {
    	return PH_ADD_COMPCODE(PH_ERR_PROTOCOL_ERROR, PH_COMP_PAL_ISO14443P3A);
    }
#endif
