                                  ...
                                  )
{
...
#ifdef NXPBUILD__PH_EMV
    /* TA001 JLL EMVCo Pcd  24/10/2011 - FDT = 500 µs - Req. 4.27 */
...
#ifdef NXPBUILD__PH_EMV
        /* TA201_X JLL 04/10/11 Emv Pcd */
        if (pDataParams->bFwi <= 0x03)
        {
        	dwFwt = dwFwt << 2;
        }
#endif
    ...
    {
#ifdef NXPBUILD__PH_EMV
    	/* TA306_XX JLL EMV Pcd  28/09/2011 - Req. 6.1.1.1 */
