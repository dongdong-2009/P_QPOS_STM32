...
#define FLASH_ID       0xef401700// 0xC84015C8
/* Dummy byte */
...
#define CMD_BE32        0x52  /* Block Erase 64k instruction */
#define CMD_BE64        0xD8  /* Block Erase 64k instruction */
#define CMD_CE        	0xC7  /* Chip Erase instruction */
#define CMD_UPS       	0x39	/* Unprotect Sector */
#define CMD_PS        	0x36	/* Protect Sector */
#define BUSY_FLAG      	0x01  /* Write In Progress (WIP) flag */
#define WE_FLAG      	0x02  /* Write In Progress (WIP) flag */
#define GLOPS         	0x18
#define GLOUPS        	0xe3

#define CMD_RPD_HPM   	0xab  /* Release Power down orHPM / Device ID */
/* Start Data tokens  */
...
void SPI_FLASH_GlobalUnprotect(void);
void SPI_FLASH_GlobalProtect(void);
